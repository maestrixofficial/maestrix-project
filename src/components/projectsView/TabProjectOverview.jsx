                    ...
                    <div className="row">
                        ...
                        <div className="card stretch stretch-full mt-3">
                            <div className="card-body">
                                ...
                                <p><span className="fw-semibold">Status:</span> In Progress</p>
                                <p><span className="fw-semibold">Difficulty:</span> Intermediate</p>
                                <p><span className="fw-semibold">Tags:</span> <span className="badge bg-soft-primary text-primary me-2">React</span> <span className="badge bg-soft-success text-success me-2">Frontend</span> <span className="badge bg-soft-warning text-warning">UI/UX</span></p>
