...
import { customerListTagsOptions, projectBillingOptions, projectDifficultyOptions, projectStatusOptions, projectTagsOptions, propasalLeadOptions } from '@/utils/options'
import MultiSelectTags from '@/components/shared/MultiSelectTags';
import DatePicker from 'react-datepicker';
import useDatePicker from '@/hooks/useDatePicker';
import ReactQuill from 'react-quill';

const TabProjectDetails = ({extraSteps,setExtraSteps}) => {
                    ...
                    <fieldset>
                       ...
                       {/*  <div className="mb-4">
                        ...
                        <div className="mb-4">
                            ...
                            <label htmlFor="projectDifficulty" className="form-label">Project Difficulty Level <span className="text-danger">*</span></label>
                            <SelectDropdown
                        ...
                        <div className="mb-4">
                        <label htmlFor="tabCount">Number of extra tabs (max 10):</label>
                        <input
                            type="number"
                            id="tabCount"
                            min="0"
                            ...
                            value={extraSteps}
                            onChange={(e) => {
                                let value = Math.min(10, Math.max(0, parseInt(e.target.value || 0)));
                                setExtraSteps(value);
                            }}
                        /></div>
                        <div className="mb-4">
