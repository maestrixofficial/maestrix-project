...
// ];
const projectData = [
    { project_name: 'NFT Mobile Apps Developemnt', progress: '40', progress_color: '#ea4d4d', },
    { project_name: 'NFT Mobile Apps Developemnt', progress: '85', progress_color: '#3454d1', },
    { project_name: 'NFT Mobile Apps Developemnt', progress: '50', progress_color: '#ffa21d', },
    { project_name: 'NFT Mobile Apps Developemnt', progress: '75', progress_color: '#17c666', }
];
                ...
                <div className="card-body">
                    <div className="hstack justify-content-between mb-4 pb-">
                        <div>
                            ...
                            <span className="fs-12 text-muted">Recent project success rates</span> 
                        </div>
                        <Link to="#" className="btn btn-light-brand">View Alls</Link>
                    </div>
                    <div className="row g-4">
                        {projectData.map(({ progress, progress_color, project_name }, index) => (
