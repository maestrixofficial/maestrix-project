                    ...
                    <td>
                      <div className="d-flex align-items-center gap-3">
                        <div className="avatar-image">
                          <img src={user.avatar} className="img-fluid" alt="Customer" />
                        </div>
                        <div>
                          <a href="#">{user.name}</a>
                        </div>
                    ...
                    <td>
                      <div className="hstack gap-2">
                        <div className="avatar-image avatar-sm">
                          <img src={user.flag} className="img-fluid" alt="img" />
                        </div>
                        <span className="d-inline-block align-middle">{user.country}</span>
                      </div>
                    </td>
                    <td><span>{user.cardNumber}</span></td>
                    <td>{user.date}</td>
